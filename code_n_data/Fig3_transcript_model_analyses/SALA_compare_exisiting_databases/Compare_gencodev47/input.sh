...
ref_bed_gz='/analysisdata/fantom6/Interactome/ONT.CAGE.satellite/dorado_run/perl_script_for_SALA/20231113_Neuron_THP1_para_updated/Compare_gencodev47/gencode.v47.annotation.bed12.bed.gz'
