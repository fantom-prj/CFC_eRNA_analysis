...
my $outDir = "/analysisdata/fantom6/Interactome/ONT.CAGE.satellite/dorado_run/Input_iPS_chro/junction_extractor2/pool/";
system "mkdir -pm 755 $outDir";
system "cp $0 $outDir";
my $out_tag = 'iPSchro.full';
my $find_str = '/analysisdata/fantom6/Interactome/ONT.CAGE.satellite/dorado_run/Input_iPS_chro/junction_extractor2/output/*/log/*.junct.info.tsv.gz';
