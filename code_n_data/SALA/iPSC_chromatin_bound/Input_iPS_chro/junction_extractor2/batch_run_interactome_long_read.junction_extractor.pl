...
my $outDir = "/analysisdata/fantom6/Interactome/ONT.CAGE.satellite/dorado_run/Input_iPS_chro/junction_extractor2";
my $in_lib_list_path = "/analysisdata/fantom6/Interactome/ONT.CAGE.satellite/dorado_run/perl_script_for_SALA/data_link/dorado.iPSchro_all.b4.transcriptclean.BAM.txt";
