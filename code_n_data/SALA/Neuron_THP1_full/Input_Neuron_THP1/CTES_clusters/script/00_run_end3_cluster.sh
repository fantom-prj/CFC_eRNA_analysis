...
ONT_CAGE_neuron_CTES_path='/analysisdata/fantom6/Interactome/ONT.CAGE.satellite/dorado_run/Input_Neuron_THP1/CTES_clusters/end3_bed_bigwig/Neuron_THP1.end3.bed'
outputPrefix='Neuron_THP1.CTES'
