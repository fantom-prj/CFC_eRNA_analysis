...
my $outDir = "/analysisdata/fantom6/Interactome/ONT.CAGE.satellite/dorado_run/Input_Neuron_THP1/junction_extractor/pool/";
system "mkdir -pm 755 $outDir";
system "cp $0 $outDir";
my $out_tag = 'Neuron_THP1.full';
my $find_str = '/analysisdata/fantom6/Interactome/ONT.CAGE.satellite/dorado_run/Input_Neuron_THP1/junction_extractor/output/*/log/*.junct.info.tsv.gz';
