...
my $baseDir='/analysisdata/fantom6/Interactome/ONT.CAGE.satellite/dorado_run/SCAFE/20231126/ont_ss_Neuronalone/aggregate/pool_runs';
my $run_script = '/analysisdata/fantom6/Interactome/ONT.CAGE.satellite/dorado_run/SCAFE/20231126/ont_ss_Neuronalone/script/00_run_aggregate_bam_to_ctss_only.sh';
my $run_list_path = '/analysisdata/fantom6/Interactome/ONT.CAGE.satellite/dorado_run/SCAFE/20231126/ont_ss_Neuronalone/aggregate/00_ont_ss_Neuronalone.aggregate_list.pool_run.txt';
