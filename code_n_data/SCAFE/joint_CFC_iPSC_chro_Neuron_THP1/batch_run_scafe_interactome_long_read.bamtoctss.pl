...
my $outDir = "/analysisdata/fantom6/Interactome/ONT.CAGE.satellite/dorado_run/SCAFE/20231126/iPSchro/ontCAGE/bam_to_ctss";
...
my $in_lib_list_path = "/analysisdata/fantom6/Interactome/ONT.CAGE.satellite/dorado_run/perl_script_for_SALA/data_link/dorado.iPSchro_BAM.no_index.txt";
