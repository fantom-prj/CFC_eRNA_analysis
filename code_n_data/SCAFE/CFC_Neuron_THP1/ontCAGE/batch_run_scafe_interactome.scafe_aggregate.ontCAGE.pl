...
my $baseDir='/analysisdata/fantom6/Interactome/ONT.CAGE.satellite/dorado_run/SCAFE/20231126/Neuron_THP1_S3/ontCAGE/aggregate/run_full';
my $run_script = '/analysisdata/fantom6/Interactome/ONT.CAGE.satellite/dorado_run/SCAFE/20231126/Neuron_THP1_S3/ontCAGE/script/00_run_full.sh';
my $ctss_list_path = '/analysisdata/fantom6/Interactome/ONT.CAGE.satellite/dorado_run/SCAFE/20231126/Neuron_THP1_S3/ontCAGE/aggregate/pool_runs/ctss_bed/00_pool_runs.ctss_list.tsv';
...
while (<INCTSSLIST>) {
	...
	my $cell_type_scope = "ontCAGE.$cell_type";
	my $all_scope = "ontCAGE.Neuron_THP1";
